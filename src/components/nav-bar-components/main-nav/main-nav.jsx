        ...
        <Row>
            <Navbar key="lg" sticky="top" className="mb-3 Site-nav">
                ...
                <Navbar.Brand href="/">
                    ...
                    <NavDropdown title="Sexual Health" id="collasible-nav-dropdown">
                    ...
                    <NavDropdown title="Diseases & Disorders" id="collasible-nav-dropdown">
                                    <NavDropdown.Item href="#action/3.1">Action</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.2">Action</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.3">Action</NavDropdown.Item>
                                </NavDropdown>
                    <NavDropdown title="Culture & Lifestyle" id="collasible-nav-dropdown">
                                    <NavDropdown.Item href="#action/3.1">Action</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.2">Action</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.3">Action</NavDropdown.Item>
                                </NavDropdown>
